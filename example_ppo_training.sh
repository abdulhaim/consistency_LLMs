...
CUDA_VISIBLE_DEVICES=3,4,5 ray start --head --node-ip-address 0.0.0.0 --dashboard-port=8270 --port=6383  --dashboard-agent-listen-port=52367 --num-gpus 2 --temp-dir=/raid/users/ryan_cheng2/tmp27
CUDA_VISIBLE_DEVICES=4 ray start --head --node-ip-address 0.0.0.0 --dashboard-port=8270 --port=6383  --dashboard-agent-listen-port=52367 --num-gpus 1 --temp-dir=/raid/users/ryan_cheng2/tmp
